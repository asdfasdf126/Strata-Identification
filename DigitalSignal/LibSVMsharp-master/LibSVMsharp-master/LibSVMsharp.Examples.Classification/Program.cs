...
namespace LibSVMsharp.Examples.Classification
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SVMProblem trainingSet = SVMProblemHelper.Load(@"Dataset\mod2.txt");
            SVMProblem testSet = SVMProblemHelper.Load(@"Dataset\mod2.txt");
            ...
            // Save the model
            SVM.SaveModel(model, @"Model\mod2_model.txt");
